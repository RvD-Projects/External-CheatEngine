    ...
    pub mod schemas {
        ...
        pub mod server_dll {
            ...
            pub mod CBaseViewModel {
                ...
                pub const m_hOldLayerSequence: usize = 0x9E0; // 
            ...
            // Field count: 19
            pub mod CFire {
                pub const m_hEffect: usize = 0x790; // 
            ...
            pub mod CCSWeaponBase {
                ...
                pub const m_seqIdle: usize = 0xDBC; // 
                pub const m_seqFirePrimary: usize = 0xDC0; // 
                pub const m_seqFireSecondary: usize = 0xDC4; // 
                pub const m_thirdPersonFireSequences: usize = 0xDC8; // CUtlVector<HSequence>
                pub const m_hCurrentThirdPersonSequence: usize = 0xDE0; // 
            ...
            pub mod CCSPlayerPawn {
                ...
                pub const m_nLastKillerIndex: usize = 0x1960; // 
                ...
                pub const m_iBombSiteIndex: usize = 0x1994; // 
            ...
            pub mod CBasePlayerPawn {
                ...
                pub const m_iHltvReplayEntity: usize = 0xC38; // 
