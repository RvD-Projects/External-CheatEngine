...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Backend Flags"))
        {
            ...
            ImGui::CheckboxFlags("io.BackendFlags: GuiHasVtxOffset", &io.BackendFlags, ImGuiBackendFlags_GuiHasVtxOffset);
            ImGui::EndDisabled();
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    if (show_config_info)
    {
        ...
        ImGui::Text("io.BackendGuiName: %s", io.BackendGuiName ? io.BackendGuiName : "NULL");
        ...
        if (io.BackendFlags & ImGuiBackendFlags_GuiHasVtxOffset)   ImGui::Text(" GuiHasVtxOffset");
        ImGui::Separator();
